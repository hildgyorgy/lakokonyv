...
> **Későbbi forrásrendezés, 2026. szeptember 19.:** az alább leírt könyvkeretet
> és nyolc fejezetfájlt teljes metaadat-tartalmukkal egyesítettük a
> `sources/xml/Bito_konyv_hu.xml` archívumban. A részfájlokat és a többszörös
> DocBook JPG/PNG exportokat ezután eltávolítottuk. A 164 PDF ábraforrás a
> `sources/originals/figures-pdf/` mappába került. Az alábbi felsorolás az audit
> idején kapott csomag történeti leírása.
